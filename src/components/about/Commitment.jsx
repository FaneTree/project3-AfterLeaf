    ...
    return (
        <div>
            ...
            <div className="commitment-container">
                ...
                <div>
                    <p className="commitment-topic">To celebrate the value of plants at every stage of their lives</p>
            ...
            <div className="commitment-container">
                ...
                <div>
                    <p className="commitment-topic">To keep our selves honest</p>
            ...
            <div className="commitment-container">
                ...
                <div>
                    <p className="commitment-topic">To make Australia grenner</p>
