    ...
    return (
        <div className = 'content'>
            ...
            <div className="p-container">
                ...
                <p>Well, it all started in late 2019 in Surry Hills, Sydney.</p>
                <p>Our CEO, Nicole, had big aspirations to become a houseplant queen, but things didn't quite plan out that way.</p>
